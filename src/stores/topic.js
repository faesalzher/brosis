const topic = [
  ...
  {
    _id: 5,
    name: "Cara Membersihkan AC Lorem ipsum dot labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud ",
    background: "https://cdn.statically.io/img/9to5mac.com/2018/06/05/macos-mojave-wallpapers-download/mojave-day/",
    createdAt: new Date().toString(),
  },
  {
  ...
  {
    _id: 5,
    name: "Cara Membersihkan asdasdasd Lorem ipsum dolor sit amet, conse ",
    background: "https://cdn.statically.io/img/9to5mac.com/2018/06/05/macos-mojave-wallpapers-download/mojave-day/",
    createdAt: new Date().toString(),
  },
  {
